...
import { TeacherOCRImportButton } from "@/components/teacher-ocr-import-button"
              ...
              <>
                ...
                <div className="sm:hidden">
                  ...
                  <div className="mb-4 flex flex-col gap-2">
                    <ImportTeacherGoogleClassroomButton onImportComplete={handleImportComplete} />
                    <TeacherOCRImportButton onImportComplete={handleImportComplete} />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {classroomCourses.length > 0 ? (
                    ...
                    <Card className="p-4 sm:p-8 text-center space-y-3">
                      <p className="text-muted-foreground text-sm sm:text-base">還沒有任何課程</p>
                      {/* 教師專用導入 */}
