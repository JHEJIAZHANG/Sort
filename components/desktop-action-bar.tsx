...
export function DesktopActionBar({ onAddCourse, onAddAssignment, onAddNote, onAddExam }: DesktopActionBarProps) {
  return (
    <div className="hidden lg:flex lg:items-center lg:justify-between lg:p-4 lg:bg-white lg:border-b lg:border-border lg:ml-[var(--sidebar-width)] lg:transition-[margin] lg:duration-300">
