...
export function TeacherBottomNavigation({ activeTab, onTabChange }: TeacherBottomNavigationProps) {
  const tabs = [
        ...
        {tabs.map((tab, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex flex-col items-center gap-1 px-2 py-2 rounded-xl transition-all duration-300 min-w-[50px] min-h-[56px] touch-manipulation relative overflow-hidden group",
